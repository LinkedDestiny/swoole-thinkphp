...
class View {
    ...
    public function fetch($templateFile='',$content='',$prefix='') {
        if(empty($content)) {
            ...
            defined('THEME_PATH') or    runkit_constant_redefine('THEME_PATH', $this->getThemePath());
        }
        // 页面缓存
        ob_start();
        ob_implicit_flush(0);
    ...
    public function parseTemplate($template='') {
        ...
        // 获取当前主题的模版路径
        defined('THEME_PATH') or    runkit_constant_redefine('THEME_PATH', $this->getThemePath($module));
    ...
    private function getTemplateTheme() {
        ...
        defined('THEME_NAME') || runkit_constant_redefine('THEME_NAME',   $theme);                  // 当前模板主题名称
        return $theme?$theme . '/':'';
    }
